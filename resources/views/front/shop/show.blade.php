                            ...
                            <div class="product-details">
                                ...
                                <div class="pd-desc">
                                    ...
                                    @if($product->discount != null)
                                        <h4>{{ $product->discount }}<sup>đ</sup> <span>{{ $product->price }}<sup>đ</sup></span></h4>
                                    @else
                                        <h4>{{ $product->discount }}<sup>đ</sup></h4>
                                    @endif
...
{{--                                </div>--}}
                                <div class="pd-size-choose">
                                    @foreach(array_unique(array_column($product->productDetails->toArray(), 'size')) as $productSize)
                                        <div class="sc-item">
                                            <input type="radio" id="xl-{{ $productSize }}">
                                            <label for="xl-{{ $productSize }}">{{ $productSize }}</label>
                                        </div>
                                    @endforeach
                                    ...
                                    <div class="specification-table">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="p-price">{{ $product->price }}<sup>đ</sup></div>
                                                </td>
                                            </tr>
                                            <tr>
